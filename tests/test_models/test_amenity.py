...
Unittest classes:
    ...
    TestAmenitySaveMethod
    TestAmenityToDictMethod
"""
import os
import models
import unittest
...
class TestAmenityInstantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Test that Amenity instantiation works with no arguments."""
    ...
    def test_args_unused(self):
        """Test that Amenity instantiation ignores unused arguments."""
        am = Amenity(None)
...
class TestAmenitySaveMethod(unittest.TestCase):
    ...
    def test_one_save(self):
        """Test that a single save updates the updated_at timestamp."""
        am = Amenity()
        sleep(0.05)
    ...
    def test_two_saves(self):
        """Test that two consecutive saves update the updated_at timestamp."""
        am = Amenity()
        sleep(0.05)
        first_updated_at = am.updated_at
        am.save()
...
class TestAmenityToDictMethod(unittest.TestCase):
    ...
    def test_to_dict_type(self):
        """Test that the output of to_dict is a dictionary."""
    ...
    def test_contrast_to_dict_dunder_dict(self):
        """Test that to_dict differs from the __dict__ attribute."""
        am = Amenity()
